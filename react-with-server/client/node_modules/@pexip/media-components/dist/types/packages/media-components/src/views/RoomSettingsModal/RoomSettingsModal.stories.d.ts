...
import type { RoomSettingsModalViewProps } from './RoomSettingsModal.view';
declare const _default: {
    ...
    component: React.FC<React.ClassAttributes<HTMLDivElement> & React.HTMLAttributes<HTMLDivElement> & {
        ...
        isOpen: boolean;
        onSave: (hours: number, minutes: number, participantsCanLeave: boolean) => void;
        onCancel: () => void;
        timerValues: import("./RoomSettingsModal.view").TimerValues;
    }>;
    parameters: {
        layout: string;
    };
...
export declare const RoomSettingsModal: Story<RoomSettingsModalViewProps>;
//# sourceMappingURL=RoomSettingsModal.stories.d.ts.map