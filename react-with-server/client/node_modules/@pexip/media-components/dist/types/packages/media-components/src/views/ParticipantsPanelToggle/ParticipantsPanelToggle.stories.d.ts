...
import { ParticipantsPanelToggleView } from './ParticipantsPanelToggle.view';
declare const _default: {
    component: React.FC<((((Omit<React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, "ref"> | Omit<React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref"> | Omit<React.DetailedHTMLProps<React.AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>, "ref">) & {
        ...
        isPanelOpen: boolean;
        inMeetingParticipantsCount?: number | undefined;
        participantsActionCount?: number | undefined;
...
export declare const Main: StoryFn<React.ComponentProps<typeof ParticipantsPanelToggleView>>;
export declare const Notification: StoryFn<React.ComponentProps<typeof ParticipantsPanelToggleView>>;
//# sourceMappingURL=ParticipantsPanelToggle.stories.d.ts.map